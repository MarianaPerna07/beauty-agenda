              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-lg text-[#5c7160]">Rua das Flores, 123</p>
                    <p className="text-lg text-[#5c7160]">1000-123 Lisboa</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-lg text-[#5c7160]">Segunda - Sexta: 9h - 20h</p>
                    <p className="text-lg text-[#5c7160]">Sábado: 9h - 18h</p>
